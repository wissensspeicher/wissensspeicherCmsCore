...
//	private List<BbawDocument> parsingResultsList;
	PrintWriter out;
...
//	public PathExtractor(PrintWriter out){
//		System.out = out;
//	}
	...
	public List<String> initExtractor(String startingUri){
		...
		System.out.println("<br>");
//	 	for (String s : ressourceLoc) {
//			System.out.println("resource Locations : "+s);
//		}
...
//				    	System.out.println("tss "+reader.getLocalName());
	...
	/**
	 * extrahiert ebenso wie extractDocLocations(String startUri) Pfade, tut dies aber local und nicht über HTTP
	 * @return
	 */
...
//
//			out.println("in configslist : "+string);
//			out.println("<br/>");
//		}
		return pathList;
	}
