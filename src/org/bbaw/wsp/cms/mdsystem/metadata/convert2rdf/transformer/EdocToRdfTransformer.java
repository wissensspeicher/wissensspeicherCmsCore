...
import org.bbaw.wsp.cms.mdsystem.metadata.convert2rdf.transformer.integrator.EdocNormdataIntegrator;
...
/**
 * Instances of this (singleton) class transform eDoc metadata to the destination OAI/ORE files.
 * 
...
public class EdocToRdfTransformer extends ToRdfTransformer {
  ...
  private EdocToRdfTransformer() throws ApplicationException {
    ...
    normdataIntegrator = new EdocNormdataIntegrator();
  }
   ...
   * (non-Javadoc)
   * 
   * @see bbaw.wsp.parser.metadata.transformer.ToRdfTransformer#doTransformation( java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * Convert an input string to a language term. This language terms follows the ISO iso639-3 specification.
   * 
   * @param language
