...
public class JenaMain {
	...
	// static final String oreBiblio X=
	 ...
	 */
	public JenaMain(String datatoConvert, String pathtoSave) {
	...
	public void initStore() {
		wspStore = new WspRdfStore(pathtoSave);
	...
	private void doYourWork() {
		// createNamedModelsFromOreSets(datatoConvert);
		// createNewModelFromSingleOre(oreBiblioNeu);
		// getAllNamedModelsInDataset();
		createNewModelFromSingleOre(datatoConvert);
	...
	private void createNewModelFromSingleOre(String location) {
		...
		rdfAbout = manager.scanID(location);
		if (rdfAbout == null) {
			rdfAbout = getID();
		}
	...
	private String getID() {
		File file = new File(datatoConvert);
		return "http://" + file.getName();
	}
