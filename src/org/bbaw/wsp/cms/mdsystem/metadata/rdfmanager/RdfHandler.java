...
public class RdfHandler {
	 ...
	 * @param literalObj
	 */
	public void updateByJenaApi(Model model, String uri, String predicate,
			String literalObj) {
		System.out.println("adding ...");
		model.add(model.createResource(uri), model.createProperty(predicate),
				model.createLiteral(literalObj));
		model.commit();
		model.close();
	 ...
	 * @param literalObj
	 */
	public void deleteByJenaApi(Model model, String uri, String predicate,
			String literalObj) {
	...
	public void count(Dataset dataset) {
		...
		System.out.println("");
		System.out
				.println("_____________triples im defaultgraph_______________");
		try {
