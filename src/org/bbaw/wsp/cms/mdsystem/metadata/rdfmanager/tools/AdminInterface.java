...
public class AdminInterface extends JFrame {
	...
	textFieldSrc.addFocusListener(new FocusListener() {
	...
	textFieldDes.addFocusListener(new FocusListener() {
	...
	textFieldLarq.addFocusListener(new FocusListener() {
	...
	panel.add(btn_src);
	panel.add(textFieldSrc);
	panel.add(btn_des);
	panel.add(textFieldDes);
	panel.add(btn_larq);
	panel.add(textFieldLarq);
     ...
     * was pressed. Also exceptionhandling if wrong data were given
     * 
     * @param b
     */
	...
	b.addActionListener(new ActionListener() {
		...
		if (ev.getActionCommand().equals(SET_NEW_LARQ)) {
		    ...
		    if (srcD == null) {
			textFieldSrc.setText("no Source Folder selected");
		    } else
			textFieldSrc.setText(srcD);
		    ...
		    if (desF == null) {
			textFieldDes.setText("no Destination selected");
		    } else
			textFieldDes.setText(desF);

		    LOGGER.info(textFieldDes + " as source selected.");
