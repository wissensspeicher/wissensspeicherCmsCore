...
//		dataset.close();
    ...
    private void createNewModelFromSingleOre(String file){
    	...
    	String rdfAbout = checkifValid(manager.scanID(file));
    	System.out.println(rdfAbout);
    ...
    /**
     * Checks if titel is null it generates one by document name else 
     * it returns given string;
     * @param titel
     * @return
     */
    private String checkifValid(String titel){
    	if (titel == null){
    	
    		File file = new File(srcD);
