...
public class MdsystemConfigRecord implements IMdsystemConfigRecord {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((eDocTemplatePath == null) ? 0 : eDocTemplatePath.hashCode());
    result = prime * result + ((larqIndexPath == null) ? 0 : larqIndexPath.hashCode());
    result = prime * result + ((metsStylesheetPath == null) ? 0 : metsStylesheetPath.hashCode());
    result = prime * result + ((modsStylesheetPath == null) ? 0 : modsStylesheetPath.hashCode());
    return result;
  }
