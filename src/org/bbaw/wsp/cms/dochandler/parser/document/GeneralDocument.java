...
public class GeneralDocument implements IDocument {
	...
	public GeneralDocument(final String url, final String fulltext) {
		if (url == null) {
			throw new IllegalArgumentException(
					"The value for the parameter URL in GeneralDocument mustn't be null.");
		}
		if (fulltext == null) {
			throw new IllegalArgumentException(
					"The value for the parameter fulltext in GeneralDocument mustn't be null.");
		}
	...
	public String toString() {
		...
		builder.append("GeneralDocument [textOrig=");
		builder.append(textOrig);
		builder.append(", url=");
		builder.append(url);
	...
	/**
	 * Set the textOrig. This is necessary if the sub classes of
	 * {@link ResourceParser} need to change an recieved fulltext.
	 * 
	 * @param textOrig
	 */
